...
cortexbrain_kernel=$(cat /res/synapse/nvm/cortexbrain_kernel);
cortexbrain_system=$(cat /res/synapse/nvm/cortexbrain_system);
cortexbrain_wifi_auto=$(cat /res/synapse/nvm/cortexbrain_wifi_auto);
cortexbrain_media_manager=$(cat /res/synapse/nvm/cortexbrain_media_manager);
cortexbrain_nmi_auto=$(cat /res/synapse/nvm/cortexbrain_nmi_auto);
...
if [ "$cortexbrain_background_process" -eq "1" ] && [ "$(pgrep -f "/system/xbin/cortexbrain-tune.sh" | wc -l)" -eq "2" ]; then
	(while true; do
		sleep "3";
