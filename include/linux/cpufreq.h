...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_ONDEMAND_SEC)
extern struct cpufreq_governor cpufreq_gov_ondemand_sec;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_ondemand_sec)
